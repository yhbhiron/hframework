...
FCKConfig.ToolbarSets["Basic"] = [
	['FontFormat','FontName','FontSize','Bold','Italic','-','TextColor','-','OrderedList','UnorderedList','RemoveFormat'],
	'/',
	['JustifyLeft','JustifyCenter','JustifyRight'],
	['Link','Unlink','Image','Flash','Smiley','FitWindow','Source']
] ;
...
FCKConfig.ToolbarSets["Blog"] = [
	['FontName','Bold','Italic','-','OrderedList','UnorderedList','RemoveFormat'],
	'/',
	['JustifyLeft','JustifyCenter','JustifyRight'],
